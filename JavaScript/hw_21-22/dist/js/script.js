...
var app = {
  test: {
    ...
    answers: [['Вариант ответа №1', 'Вариант ответа №2', 'Вариант ответа №3'], ['Вариант ответа №1', 'Вариант ответа №2', 'Вариант ответа №3', 'Вариант ответа №4', 'Вариант ответа №5'], ['Вариант ответа №1', 'Вариант ответа №2', 'Вариант ответа №3'], ['Вариант ответа №1', 'Вариант ответа №2']],
    rightAnsw: ['q0a0', 'q1a0', 'q2a0', 'q3a0']
  },
  radioAll: null,
  checkedRadioValues: null,
  result: null,
  genModal: function genModal() {
  ...
  checkResult: function checkResult(e) {
    app.cleanResults();
    app.getUserAnswers();
  ...
  restoreChekedRadio: function restoreChekedRadio() {
    $.each(app.radioAll, function (i) {
      if (app.radioAll[i].checked) app.radioAll[i].checked = !app.radioAll[i].checked;
    });
  },
  showResultInModal: function showResultInModal() {
    app.checkResult();

    if (app.result) {
      //не понятно с this - вместо app не подходит
      $(openModal).addClass('modalDialog--active').css('background', 'rgba(100,250,100,0.8)').find('h2').html('Тест пройден успешно!');
    } else {
      $(openModal).addClass('modalDialog--active').css('background', 'rgba(0,0,0,0.8)').find('h2').html('Тест провален. Попробуйте еще.');
    };
  ...
  closeModalLink: function closeModalLink() {
